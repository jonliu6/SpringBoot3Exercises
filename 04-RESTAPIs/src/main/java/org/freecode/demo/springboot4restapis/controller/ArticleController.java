...
import org.freecode.demo.springboot4restapis.exception.ArticleAlreadyExistsException;
...
import org.freecode.demo.springboot4restapis.model.ArticleErrorResponse;
...
public class ArticleController {
	...
	@GetMapping("/articles")
	/**
	 * URL: http://<server>:<port>/rest/articles
	 * @return
	 */
	...
	/**
	 * URL: http://<server>:<port>/rest/articles/Visual C%23 2008
	 * @param title
	 * @return
	 */
	...
	/**
	 * URL: http://<server>:<port>/rest/articles/Git%20Common%20Commands
	 * @param title
	 */
